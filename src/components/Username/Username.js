...
const [password2,setPassword2] = useState(()=>{
   if(!localStorage.getItem("password2")){
    ...
    const style1 = {position:"absolute", marginTop:"3.5rem", marginLeft:"7rem"}
           ...
           <form  pt='1rem'>
                  <Box>
                     <InputGroup>
                        ...
                        />
                           <Button h='2.5rem' size='sm'  bg='green.500'   w='4rem' _hover={{background:"green.500"}}>
                  ...
                  <Box>
                    <InputGroup>
                        ...
                        type="text" Id="text" 
                           ...
                           h='2.5rem' size='sm' _hover={{backgroung:"green.800"}} bg={updatepassword2===true? 'green.500' : 'green.700'}   w='4rem'>
                              <FaRegEdit size={30}  style={style}/>
                           </Button>
                  ...
                  <Box>
                    <InputGroup>
                        ...
                        type="text" Id="text" placeholder="name"
                        />
                     
                           <Button onClick={()=>{
                              setupdatefirst(firstname => firstname = !firstname) }}
                           h='2.5rem' size='sm' _hover={{backgroung:"green.800"}} bg={updatefirst===true? 'green.500' : 'green.700'}   w='4rem'>
                              <FaRegEdit size={30}  style={style}/>
                           </Button>
                    </InputGroup>
                  </Box>
                    ...
                    <InputGroup>
                        ...
                        />
                           ...
                           h='2.5rem' size='sm' _hover={{backgroung:"green.800"}} bg={updateemail===true? 'green.500' : 'green.700'}  w='4rem'>
                              <FaRegEdit size={30}  style={style}/>
                           </Button>
                    </InputGroup>
                    ...
                    <Box>
                     <InputGroup>
                        ...
                        type="text" Id="text" placeholder="Username"
                        />
                           <Button onClick={()=>{
                              setupdateuser(user => user = !user)
                           }} h='2.5rem' size='sm' _hover={{backgroung:"green.800"}} bg={updateuser===true? 'green.500' : 'green.700'}   w='4rem'>
                              <FaRegEdit size={30}  style={style}/>
                           </Button>
                    </InputGroup>
                  </Box>
                    <br />
                    <Button ml='15rem'   width='8rem' bg='green.500' color='white' _hover={{background:"green.600", color:"white"}}>Update</Button>
            </form>
