      ...
      />
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ml-10" style={{marginLeft:"auto"}}>
            ...
            <Link to="/OrgLogin"><button style={{borderRadius:"5px",padding:".5rem", marginLeft:"1rem", backgroundColor:"rgb(46, 46, 78)", color:"white",border:"1px solid blue"}}>Sign In</button></Link>
          </Nav>
        </Navbar.Collapse>
      </Container>
    </Navbar>
