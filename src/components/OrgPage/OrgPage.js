...
const OrgPage = () =>{
    const color = {color:"blue", marginLeft:"1rem", backgroundColor:"#F0F5FF", borderRadius:"50%"}
    const colors = {color:"yellow", marginLeft:"1.8rem", backgroundColor:"#FFBD82", borderRadius:"50%"}
    const colorss = {color:"#FF86AC", marginLeft:"2.4rem", backgroundColor:"#FFBD82", borderRadius:"50%"}
    const colorsss = {color:"blue", marginLeft:"2.4rem", backgroundColor:"#F0F5FF", borderRadius:"50%"}
                    ...
                    <Box w='99%' h='9rem' bg='#ffff' boxShadoow='md' ml='2rem'>
                        ...
                        <Flex ml='8rem'>
                            <Box justifyContent='center' alignItems='center' mt='1rem'>
                                ...
                                <Heading fontSize='1.5rem' ml='.8rem'>127</Heading>
                                <Text>Submitted</Text>
                            </Box>
                           ...
                           <Box justifyContent='center' alignItems='center' mt='1rem' ml='6rem'>
                                ...
                                <Heading fontSize='1.5rem' ml='2rem'>58</Heading>
                                <Text>Yet To Submit</Text>
                            </Box>
                            <Image mt='1rem' h='5rem' ml='4rem' src="images/Line.png" alt="" />
                            <Box justifyContent='center' alignItems='center' mt='1rem' ml='6rem'>
                                <AiOutlineLoading3Quarters style={colorss} size={35}/>
                                <Heading fontSize='1.5rem' ml='2.5rem'>42</Heading>
                        ...
                        <Flex mt='2rem' ml='1rem'>
                            <Box h='24rem' w='50%' bg='#ffff' boxShadoow='xl' >
                                <Flex columnGap='2rem'>
                                    <Heading fontSize='1.3rem' ml='1rem'>Submitted Quiz</Heading>
                                    <Input w='20rem' h='2rem' type="text" placeholder='search for students'/>
                                </Flex>
                                <TableContainer>
                                <Table variant='simple'>
                                    ...
                                    <Tr>
                                        ...
                                        <Td>James Bryan</Td>
                                        <Td>10:45 (AM)</Td>
                                        <Td color='#4FD0FF' bg='#E0F6FE' rounded='xl'>90</Td>
                                    </Tr>
                                    <Tr>
                                        <Td>Brandon</Td>
                                        <Td>11:00 (AM)</Td>
                                        <Td bg='#f7d59e' color='yellow' rounded='xl'>60</Td>
                                    </Tr>
                                    <Tr>
                                        <Td>Krispam</Td>
                                        <Td>10:00 (AM)</Td>
                                    ...
                                    <Tr>
                                        <Td>Chioma</Td>
                                        <Td>7:30 (AM)</Td>
                                        <Td bg='#f7d59e' color='yellow' rounded='xl'>70</Td>
                                    </Tr>
                                    <Tr>
                                        <Td>Nasuk</Td>
                                        <Td>9:20 (AM)</Td>
                                        <Td color='#4FD0FF' bg='#E0F6FE' rounded='xl'>98</Td>
                                    </Tr>
                                    </Tbody>
                                ...
                                <Box  h='24rem' w='50%' bg='#ffff' boxShadoow='xl' ml='1rem'>
                                    ...
                                    <Box>
                                        <Flex ml='5rem'>
                                            ...
                                            <Heading ml='3rem' fontSize='1.2rem'>70%</Heading>
                                        </Flex>
                                        <Flex ml='5rem'>
                                            <BsCircleFill style={goods}/>
                                            <Text ml='2rem'>Average Performance</Text>
                                            <Heading ml='3.5rem' fontSize='1.2rem'>20%</Heading>
                                        </Flex>
                                        <Flex ml='5rem'>
                                            <BsCircleFill style={goodss}/>
                                            <Text ml='2rem'>Poor Performance</Text>
                                            <Heading ml='5rem' fontSize='1.2rem'>10%</Heading>
                                        </Flex>
                                    </Box>
                            </Box>
                        </Flex>
